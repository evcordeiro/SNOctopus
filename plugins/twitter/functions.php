...
/* Miscellaneous Twitter Plugin Methods */

function postErrorMessage($error_message = NULL)
{
	echo ("<font size='14'>Sorry, there was an error processing your authorization</font><br>");
	echo ("Error Message: " . $error_message . "<br><br><br><br>");
	echo ("<font size='10'><a href='http://sno.wamunity.com/build/ui/networks.php'>Return to SNOctopus</a></font>");
}
